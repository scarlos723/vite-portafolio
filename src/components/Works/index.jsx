...
import { Container, Section, TextBox, VideoContainer } from './styles'
import { BiRightArrow } from 'react-icons/bi'
import videoRequi from '../../assets/videos/requivideoTrim.mp4'
      ...
      <Section>
        ...
        <VideoContainer>
          <video className='videoTag' autoPlay loop muted>
            <source src={videoRequi} type='video/mp4' />
          </video>
        </VideoContainer>
      </Section>
