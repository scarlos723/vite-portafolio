...
const Experience = () => {
  ...
  return (
    <section className="container relative z-10 containe min-h-[100dvh]">
      <div>
        <motion.h1 className='text-white text-center mb-20'
...

          {
            list.map((item, index) => (
              <motion.article 
                ...
                key={index} className={`text-balance box-content bg-gray-100 bg-opacity-10 rounded-xl p-10 lg:w-full ${item.className}`}>
