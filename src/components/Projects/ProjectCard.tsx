...
const ModalImage = ({
  ...
  <div
    className='absolute w-full h-screen left-0 top-0 bg-black/80 backdrop-blur-sm z-[9999] flex items-center justify-center p-4'
    onClick={closeModal}
  >
    {/* Modal content */}
    <div className='relative max-w-7xl max-h-[90vh] w-full'>
      ...
      <button
        onClick={closeModal}
        className='absolute text-white hover:text-gray-300 transition-colors duration-200 z-10 -top-20'
      >
        <svg
          className='w-8 h-8'
          fill='none'
