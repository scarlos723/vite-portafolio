...
const item_list = [
  ...
  },
  {
    title: "",
    description:
      "Harvard - Introduction to Artificial Intelligence whit Python",
    url: "https://courses.edx.org/certificates/97150a4aec6146cba244943849213339",
  },
  {
    title: "",
    description:
      "Blockchain Academy Chile - Desarrollo de contratos inteligentes con Solidity",
  ...
  return (
    <section className="py-20 ">
      <div className="container">
        <h2 className="text-center mb-20 text-3xl lg:text-5xl font-bold bg-gradient-to-r from-blue-400 to-purple-500 bg-clip-text text-transparent">
          Formación
        </h2>
        <div className="grid gap-10 lg:gap-20 lg:grid-cols-2 items-start max-w-7xl mx-auto">
          <div>
              ...
              <article className="relative z-10 grid gap-8">
                <div className="flex gap-4 items-center">
                  ...
                  <div className="p-3 bg-blue-500/20 rounded-full group-hover:bg-blue-500/30 transition-all duration-300">
                    <HiOutlineAcademicCap color="#60A5FA" size={32} />
                  </div>
                </div>
              ...
              <div className="relative z-10 space-y-8">
                <div className="flex items-center gap-4">
                  ...
                  <div className="p-3 bg-purple-500/20 rounded-full group-hover:bg-purple-500/30 transition-all duration-300">
                    <RiPresentationLine color="#A855F7" size={32} />
                  </div>
                </div>
