      ...
      <section className="container  min-h-[100vh] z-[100] py-20">
        ...
        <div className="grid gap-20 lg:grid-cols-2 items-center">
          <section className="grid">
            <div className="group relative bg-gradient-to-br from-purple-900/70 to-gray-900/80 backdrop-blur-md rounded-3xl p-8 border border-gray-600/40 hover:border-purple-400/60 transition-all duration-500 hover:scale-[1.02] hover:shadow-xl hover:shadow-purple-500/20">
